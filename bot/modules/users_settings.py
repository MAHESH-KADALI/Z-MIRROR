...
async def update_user_settings(query):
    ...
    if not ospath.exists(tpath):
        tpath = "https://graph.org/file/ad44811ab5757a1b143b6.jpg"
...
Examples:
1. <code>{escape('<b>Join: @hexafreinds</b>')}</code> 
This will give output as:
<b>Join: @hexafreinds</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @hexafreinds</code>')}</code> 
This will give output as:
<code>Join: @hexafreinds</code> <code>69MB.bin</code>.
...
Examples: <code>mltb|jmdkh|wzml|Z-mirror</code>
